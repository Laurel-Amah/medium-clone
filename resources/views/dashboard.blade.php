<x-app-layout>
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <ul
                        ...
                        <li class="me-2">
                            <a href="#"
                                class="inline-block px-4 py-2 text-white bg-blue-800 rounded-lg !text-white !bg-blue-800">
                                All
                            </a>
                        </li>
                        @foreach ($categories as $category)
                            <li class="me-2">
                                <a href="#" class="inline-block px-4 py-2 rounded-lg 
                                                ...
                                                dark:hover:bg-gray-600 dark:hover:text-white"> {{ $category->name }}
                                </a>
                            </li>
                        @endforeach
                    </ul>
            ...
            <div class="mt-8 text-gray-900 justify-center">
                @forelse ($posts as $post)
                    <div class="flex bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mb-8">
                        ...
                        <a href="#">
                            <img class="rounded-r-lg w-36 h-full object-cover" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="" />
                        </a>
